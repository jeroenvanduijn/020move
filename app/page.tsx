...
const copy = {
  ...
  whyMobilis: {
    ...
    items: {
      nl: [
        ...
        '1,5 uur gratis parkeren voor de deur',
        'Extra aanbod: Hyrox, Personal Training, Nutrition',
      ],
      en: [
        'High-level coaching',
        ...
        '1.5 hours free parking at the door',
        'Extra services: Hyrox, Personal Training, Nutrition',
      ],
    },
  },
  aboutMobilis: {
    ...
    accessibility: {
      nl: 'Dit aanbod geldt voor locatie Amstel. Interesse in Buitenveldert? Neem contact op voor een individueel voorstel.',
      en: 'This offer applies to the Amstel location. Interested in Buitenveldert? Contact us for an individual proposal.',
    },
  },
  location: {
    title: {
    ...
    description: {
      nl: 'Gelegen in Amsterdam Amstel, goed bereikbaar met OV en auto. 1,5 uur gratis parkeren voor de deur!',
      en: 'Located in Amsterdam Amstel, easily accessible by public transport and car. 1.5 hours free parking at the door!',
    },
    viewOnMaps: {
  ...
  moreThanWods: {
    ...
    services: [
      ...
      },
      {
        ...
        description: {
          nl: 'Beschikbaar op locatie Buitenveldert. Geen gedoe met externe afspraken.',
          en: 'Available at the Buitenveldert location. No hassle with external appointments.',
        },
        icon: 'physio',
      },
      {
        ...
        description: {
          nl: 'Voor kinderen. Spelenderwijs leren bewegen met CrossFit-principes. 10 trainingen voor €100.',
          en: 'For children. Learning to move through play with CrossFit principles. 10 classes for €100.',
        },
        icon: 'kids',
      },
      {
        ...
        description: {
          nl: 'Speciaal programma voor 55-plussers. Veilig en op eigen niveau. 10 trainingen voor €100.',
          en: 'Special program for 55+. Safe and at your own level. 10 classes for €100.',
        },
        icon: 'masters',
      },
    ],
  ...
  howItWorks: {
    ...
    steps: {
      nl: [
        'Je kiest een membership: 2x of 3x per week (Onbeperkt valt buiten deze actie).',
        'Je betaalt direct voor 2 maanden en traint heel Q1 2026 (1 januari t/m 31 maart).',
        'Deze actie is geldig t/m 31 december en alleen voor locatie Amstel.',
        'Vanaf 1 april 2026 start je automatische incasso bij Mobilis.',
        'Vanaf 1 april geldt een kalendermaand opzegtermijn.',
        'Vanaf 1 april kun je upgraden of downgraden.',
      ],
      en: [
        'Choose a membership: 2x or 3x per week (Unlimited is not part of this offer).',
        'Pay for 2 months upfront and train all of Q1 2026 (January 1 - March 31).',
        'This offer is valid until December 31 and only for the Amstel location.',
        'From April 1, 2026, your automatic direct debit starts at Mobilis.',
        'From April 1, a one-calendar-month cancellation period applies.',
        'From April 1, you may upgrade or downgrade.',
      ],
    },
  },
  pricing: {
    title: {
      nl: 'Tarieven vanaf 1 april 2026',
      en: 'Pricing from April 1, 2026',
    },
    subtitle: {
    ...
    plans: [
      { name: { nl: '2x per week', en: '2x per week' }, price: '€102', perSession: '€11,79', inDeal: true },
      { name: { nl: '3x per week', en: '3x per week' }, price: '€112', perSession: '€8,62', inDeal: true },
      ...
      { name: { nl: 'CrossFit Kids (10 trainingen)', en: 'CrossFit Kids (10 classes)' }, price: '€100', perSession: '€10', oneTime: true },
      { name: { nl: 'CrossFit Masters 55+ (10 trainingen)', en: 'CrossFit Masters 55+ (10 classes)' }, price: '€100', perSession: '€10', oneTime: true },
    ],
    headers: {
  ...
  startDate: {
    ...
    text: {
      nl: 'Je traint van 1 januari t/m 31 maart 2026 bij Mobilis Amstel. Vanaf 1 april 2026 gaan alle leden over op een automatische incasso, ongeacht wanneer je bent gestart. Meld je aan vóór 31 december.',
      en: 'Train from January 1 to March 31, 2026 at Mobilis Amstel. From April 1, 2026, all members transition to automatic direct debit, regardless of when you started. Sign up before December 31.',
    },
  },
  ctaSection: {
    title: {
